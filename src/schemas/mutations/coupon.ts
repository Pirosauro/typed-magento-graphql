 ...
 */
export type ApplyCouponToCartMutationInput = z.infer<
  typeof ApplyCouponToCartMutationInputSchema
>;
 ...
 */
export type RemoveCouponFromCartMutationInput = z.infer<
  typeof RemoveCouponFromCartMutationInputSchema
>;
